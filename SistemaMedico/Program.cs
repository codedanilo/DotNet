...
class Program
{
    ...
    static void Main()
    {
        ...
        clinica.AdicionarMedico(new Medico("Dr. Iann Asaphe", new DateTime(1980, 1, 1), "12345678901", "CRM85965"));

        clinica.AdicionarMedico(new Medico("Dra. Lara Silveira", new DateTime(1975, 5, 10), "98765432101", "CRM54321"));


        
        clinica.AdicionarPaciente(new Paciente("Paciente: Roberto Luíz", new DateTime(1990, 3, 15), "11122233344", Sexo.Masculino, "Febre, Dor de cabeça"));

        clinica.AdicionarPaciente(new Paciente("Paciente: Maria José", new DateTime(1985, 8, 20), "55566677788", Sexo.Feminino, "Dor nas costas"));
        
     clinica.AdicionarPaciente(new Paciente("Paciente: Danilo Silveira", new DateTime(1985, 6, 6), "55545677788", Sexo.Feminino, "Dor de Barriga"));

     clinica.AdicionarPaciente(new Paciente("Paciente: Roberta Nascimento ", new DateTime(1985, 8, 20), "55566977788", Sexo.Feminino, "Dente"));
